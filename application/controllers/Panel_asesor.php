...
class Panel_asesor extends CI_Controller
{
	...
	public function set_pengumuman($aksi = '', $id = '')
	{
		...
		if ($sess == NULL) {
			...
			switch ($aksi) {
				...
				case 'batal':
					$this->asesor->set_announce($aksi, $id);
					$this->session->set_flashdata('msg', 'Di Batal kan');
					redirect('panel_asesor/set_pengumuman');
					break;
	...
	public function kirim_pesan_aksi()
    {
		date_default_timezone_set("Asia/Jakarta");
			...
			//Recipients
			$mail->setFrom('youremail@gmail.com', 'LSP SMKN 6 Jakarta');
			$mail->addAddress($email, $nama_lengkap_asesi);     // Add a recipient
			
// 			$mail->addReplyTo('youremail@gmail.com', 'LSP SMK Plus Pelita Nusantara');
			...
			$mail->Subject = 'Pesan Dari Asesor ' . $nama_lengkap . ' LSP SMK PLUS Pelita Nusantara';
