...
<head>
  ...
  <title><?php echo $user['nama_lengkap']; ?>: Pendaftaran Online</title>
...
<body class="sidebar-hover theme-sltl color-green">
  <section>
    <div class="main-content">
      ...
      <!-- END TOPBAR -->
      <!-- BEGIN PAGE CONTENT -->
      <div class="flash-data-kesalahan" data-flashdata="<?= $this->session->flashdata('msgkesalahan'); ?>"></div>
      <div class="page-content page-wizard">
        <div class="header" style=" text-align: center;">
          <img src="img/logo.png" style="margin-bottom:10px;" width="100"><br>
          <h2 align="center">FORM PENDAFTARAN SERTIFIKASI PROFESI ONLINE <strong>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="style">
                    <div class="wizard-div current wizard-sea" id="register">
                      <form method="post" class="wizard wizard-validation" data-style="sky" role="form" action=""
                        ...
                        <fieldset>
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                              <span class="text-primary" style="font-size:16px;color:#222;">Apakah Anda setuju dengan
                                ketentuan Pendaftaran Sertifikasi Online diatas?</span>
                              <div class="form-group" style="padding-bottom:30px;">
                                <div class="radio bg-primary"
                                  ...
                                  <label>
                                    <input type="radio" value="cek" name="cek" data-parsley-group="block0"
                                      ...
                                      menyetujui ketentuan Pendaftaran Sertifikasi Profesi Online!</b>
                                  </label>
                                  <div id="condition-ck"
                            ...
                            <div class="col-md-12">
                              <div class="panel">
                                <div class="panel-heading" style="background: #6777EF; color: honeydew;">
                                  <h2 align="center" style="margin-top: 10px;">KONFIRMASI<br><b>DATA CALON ASESI</b>
                                  </h2>
                                </div>
                                <div class="panel-body">
                                  <span style="font-size:15px">
                                    <p align="center">Proses pendaftaran Sertifikasi Profesi Online
                                      <?php echo $user['nama_lengkap']; ?> hampir selesai. <br>Silakan periksa kembali
                                      data-data yang sudah anda masukkan.</p><br><br>
                                    <div class="col-md-12">
                                      <span class="text-primary" style="font-size:18px;"><strong>Apakah data calon asesi
                                          sudah sesuai?</strong></span>
                                      <div class="form-group">
                                        <div class="radio bg-primary p-10" style="border-radius:3px;">
                                          <label>
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>Copyright &copy; <?php echo date('Y'); ?> <a href="#"
                    target="_blank"><?php echo $user['nama_lengkap']; ?></a></span>
              </p>
              <p class="pull-right sm-pull-reset">
                <span><a href="" class="m-r-10"><i class="fa fa-home"></i> Beranda </a> | <a href="#"
                    class="m-l-10 m-r-10" data-toggle="modal" data-target=".bs-example-modal-lg"><i
                      class="fa fa-legal"></i> Ketentuan & Syarat Pendaftaran</a></span>
              </p>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    if (flashDataKesalahan) {
      Swal.fire({
        title: 'Terjadi Kesalahan!',
        text: flashDataKesalahan,
        icon: 'error'
      })
    }
  </script>
