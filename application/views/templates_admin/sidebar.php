      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo base_url('panel_admin') ?>">PSPO SMKN 6 JAKARTA</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo base_url('panel_admin') ?>">PSPO</a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Utama</li>
              ...
              <li class="kelulusan"><a class="nav-link" href="<?php echo base_url('panel_admin/set_pengumuman') ?>"><i class="fas fa-user-graduate"></i> <span>Kelulusan</span></a></li>
              <li><a class="nav-link" href="<?php echo base_url('panel_admin/kirim_pesan') ?>"><i class="fas fa-envelope"></i> <span>Kirim Pesan</span></a></li>
              <li><a class="nav-link" href="<?php echo base_url('panel_admin/print') ?>"><i class="fas fa-print"></i> <span>Print</span></a></li>
            <li class="menu-header">Data Master</li>
              <li><a class="nav-link" href="<?php echo base_url('panel_admin/data_asesi') ?>"><i class="fas fa-users"></i> <span>Data Asesi</span></a></li>
