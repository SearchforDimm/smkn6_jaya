...
<div class="container">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td>Judul</td>
            <td>:</td>
            <td>SKEMA SERTIFIKASI KKNI LEVEL II PADA KOMPETENSI MULTIMEDIA 5.7.3 ANIMASI 2D</td>
        </tr>
        <tr>
            <td>Nomor</td>
            <td>:</td>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>Membuat rekaman gambar berurutan untuk animasi</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>6.</td>
            <td>TIK.MM02.064.01</td>
            <td>Menjalankan system editing non-linear</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>7.</td>
            <td>J.591120.006.01</td>
            <td>Melakukan penyuntingan suara dan gambar bercerita (animatic previsualisation)</td>
            <td><center>SKKNI</center></td>
        </tr>
    </table>
    <br><br>
