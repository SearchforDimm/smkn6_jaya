...
<div class="container">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td>Judul</td>
            <td>:</td>
            <td>SKEMA SERTIFIKASI KKNI LEVEL II PADA KOMPETENSI MULTIMEDIA 5.7.2 DESAIN GRAFIS PERCETAKAN</td>
        </tr>
        <tr>
            <td>Nomor</td>
            <td>:</td>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>Mengidentifikasikomponen multimedia</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>3.</td>
            <td>TIK.MM01.007.01</td>
            <td>Memilih dan memakai software dan hardware untuk multimedia</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>4.</td>
            <td>TIK.MM02.032.01</td>
            <td>Membuat, memanipulasi, dan menggabung gambar 2D</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>5.</td>
        ...
        <tr>
            ...
            <td>Membuat dan memanipulasi gambar-gambar digital</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>7.</td>
            <td>TIK.MM02.070.01</td>
            <td>Menggabungkan gambar 2D kedalam sajian multimedia</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>8.</td>
            <td>TIK.MM02.071.01</td>
            <td>Menggabungkan fotografi digital kedalam sajian multimedia</td>
            <td><center>SKKNI</center></td>
        </tr>
    </table>
    <br><br>
