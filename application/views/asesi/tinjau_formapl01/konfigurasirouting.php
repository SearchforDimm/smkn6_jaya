...
<div class="container">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td>Judul</td>
            <td>:</td>
            <td>SKEMA SERTIFIKASI KKNI LEVEL II PADA KOMPETENSI TEKNIK KOMPUTER DAN JARINGAN 5.7.3 KONFIGURASI ROUTING PADA PERANGKAT JARINGAN KOMPUTER</td>
        </tr>
        <tr>
            <td>Nomor</td>
            <td>:</td>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td>1.</td>
            <td>J.611000.013.02</td>
            <td>Mengkonfigurasi Routing pada Perangkat Jaringan dalam Satu Autonomous System</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>2.</td>
            <td>J.611000.015.01</td>
            <td>Memonitor Keamanan dan Pengaturan Akun Pengguna dalam Jaringan Komputer</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>3.</td>
            <td>J.611000.023.01</td>
            <td>Mengganti Perangkat Jaringan Sesuai dengan Kebutuhan Baru</td>
            <td><center>SKKNI</center></td>
        </tr>
    </table>
    <br><br>
