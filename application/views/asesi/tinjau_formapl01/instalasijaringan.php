...
<div class="container">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td>Judul</td>
            <td>:</td>
            <td>SKEMA SERTIFIKASI KKNI LEVEL II PADA KOMPETENSI TEKNIK KOMPUTER DAN JARINGAN 5.7.1 INSTALASI JARINGAN KOMPUTER BERBASIS KABEL</td>
        </tr>
        <tr>
            <td>Nomor</td>
            <td>:</td>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>Mengumpulkan Kebutuhan Teknis Pengguna yang Menggunakan Jaringan</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>2.</td>
            <td>J.611000.002.01</td>
            <td>Mengumpulkan Data Peralatan Jaringan Dengan Teknologi yang Sesuai</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>3.</td>
            <td>J.611000.008.02</td>
            <td>Menyiapkan Kabel Jaringan</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>4.</td>
            <td>J.611000.009.02</td>
            <td>Memasang Kabel Jaringan</td>
            <td><center>SKKNI</center></td>
        </tr>
    </table>
    <br><br>
