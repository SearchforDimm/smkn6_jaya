                    ...
                    foreach ($pesan as $baris) { ?>
                        ...
                        <tr>
                            ...
                            <td class="verif-resp three-action-btn">
                                <a style="width: 50%;" href="<?php echo base_url('panel_asesor/delete_pesan/') . $baris->id_pesan ?>" class="tombol-aksi tombol-print tombol-hapus"><i class="bx bx-trash"></i></a>

                                <a style="width: 50%;" href="<?php echo base_url('panel_asesor/update_pesan/') . $baris->id_pesan ?>" class="tombol-aksi tombol-print"><i class="bx bx-edit-alt"></i></a>
                            </td>
                        </tr>
                    <?php
                    } ?>
