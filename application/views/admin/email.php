<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		...
		* {
		...
		<p style="line-height: 200%; font-size: 14px;"><span style="font-size: 16px; line-height: 32px;">Selamat anda telah berhasil terdaftar sebagai calon asesi LSP SMK Plus Pelita Nusantara untuk info lebih lanjut akan diumumkan oleh asesor lewat aplikasi LSP &amp; email mohon untuk terus melihat pesan baik di aplikasi maupun di email, terimakasih.</span></p>
		  </div>
