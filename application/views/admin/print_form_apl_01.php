        ...
        <main class="main">
            <div class="welcome-container">
                ...
                <div class="welcome-tab">
                    <span>
                        <h3 class="flex" style="gap:3px">Home<i class="bx bx-chevrons-right" style="cursor:text"></i> Print <i class="bx bx-chevrons-right" style="cursor:text"></i> Form APL 01</h3>
                    </span>
                ...
                <tbody>
                    ...
                    foreach ($asesi as $baris) { ?>
                        <tr>
                            ...
                            <td class="verif-resp">
                                <a href="<?php echo base_url('panel_admin/print_form1_aksi/') . $baris->id_siswa ?>" class="tombol-aksi tombol-print"><i class="bx bx-printer"></i>Print </a>
                            </td>
