...
<div class="container">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td>Judul</td>
            <td>:</td>
            <td>SKEMA SERTIFIKASI KKNI LEVEL II PADA KOMPETENSI REKAYASA PERANGKAT LUNAK 5.7.2 PEMROGRAMAN WEB</td>
        </tr>
        <tr>
            <td>Nomor</td>
            <td>:</td>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td>3.</td>
            <td>LOG.0001.004.01</td>
            <td>Merencanakan tugas rutin</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>4.</td>
            <td>LOG.0002.003.01</td>
