...
<div class="container">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td>Judul</td>
            <td>:</td>
            <td>SKEMA SERTIFIKASI KKNI LEVEL II PADA KOMPETENSI PERBANKAN DAN KEUANGAN MIKRO 5.7.2 PENGOPERASIAN APLIKASI KOMPUTER DAN AKUNTANSI</td>
        </tr>
        <tr>
            <td>Nomor</td>
            <td>:</td>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td>3.</td>
            <td>M.692000.022.02</td>
            <td>Mengoperasikan Paket Program Pengolah Angka/Spreadsheet</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>4.</td>
            <td>M.692000.023.02</td>
            <td>Mengoperasikan Aplikasi Komputer Akuntansi</td>
            <td><center>SKKNI</center></td>
        </tr>
    </table>
    <br><br>
