...
<div class="container">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td>Judul</td>
            <td>:</td>
            <td>SKEMA SERTIFIKASI KKNI LEVEL II PADA KOMPETENSI REKAYASA PERANGKAT LUNAK 5.7.3 PEMROGRAMAN BERORIENTASI OBJEK</td>
        </tr>
        <tr>
            <td>Nomor</td>
            <td>:</td>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>Menerapkan Perintah Eksekusi Bahasa, Pemrograman Berbasis Teks, Grafis, dan Multimedia</td>
            <td><center>SKKNI</center></td>
        </tr>
        <tr>
            <td>6.</td>
