                    ...
                    foreach ($asesi as $baris) { ?>
                        <tr>
                            ...
                            <td class="verif-resp three-action-btn">
                                <a href="<?php echo base_url('panel_admin/delete_asesi/') . $baris->id_siswa ?>" class="tombol-aksi tombol-print tombol-hapus"><i class="bx bx-trash"></i></a>
                                <a href="<?php echo base_url('panel_admin/detail_asesi/') . $baris->id_siswa ?>" class="tombol-aksi tombol-print"><i class="bx bx-search-alt-2"></i></a>
                                <a href="<?php echo base_url('panel_admin/update_asesi/') . $baris->id_siswa ?>" class="tombol-aksi tombol-print"><i class="bx bx-edit-alt"></i></a>
                            </td>
