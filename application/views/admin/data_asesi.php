                        ...
                        <table id="example" class="table table-striped table-bordered" width="100%">
                            ...
                            foreach ($asesi as $baris) { ?>
                                <tr>
                                    ...
                                    <td align="center">
                                            <a href="<?php echo base_url('panel_admin/detail_asesi/') . $baris->id_siswa ?>" class="btn btn-sm btn-success"><i class="fas fa-eye"></i></a>
                                            <a href="<?php echo base_url('panel_admin/delete_asesi/') . $baris->id_siswa ?>" class="btn btn-sm btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                            <a href="<?php echo base_url('panel_admin/update_asesi/') . $baris->id_siswa ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                    </td>
                                </tr>
                            <?php
                            } ?>
