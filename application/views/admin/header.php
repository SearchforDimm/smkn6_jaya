...
<head>
	...
	<title><?php echo $judul_web; ?> - Pendaftaran Sertifikasi Online</title>
	...
	<link rel="stylesheet" href="assets/assets_lsp/css/global.css">
	...
	<script type="text/javascript" src="assets/assets_lsp/js/scripts.js"></script>
	...
	<?php
	if ($sub_menu == "verifikasi" or $sub_menu == "set_pengumuman" or $sub_menu == "data_asesi" or $sub_menu == "kirim_pesan") { ?>
		<!-- Theme JS files -->
							...
							<div class="media">
								...
								<div class="media-body">
									<div class="text-size-mini text-muted">
										<i class="fas fa-user mr-5"></i><span style="text-transform:uppercase;"><?php echo $level; ?></span>
									</div>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == '') {
												echo 'active';
											} ?>"><a href="panel_admin"><i class="fas fa-tachometer-alt"></i> <span><b>HOME</b></span></a></li>
								...
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'verifikasi' or $sub_menu == 'edit_materi') {
												echo 'active';
											} ?>"><a href="panel_admin/verifikasi"><i class="fas fa-user-check"></i> <span><b>VERIFIKASI</b></span></a></li>

								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'set_pengumuman') {
												echo 'active';
											} ?>"><a href="panel_admin/set_pengumuman"><i class="fas fa-user-graduate"></i> <span><b>KELULUSAN</b></span></a></li>
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'export') {
												echo 'active';
											} ?>"><a href="Siswa"><i class="fas fa-file-export"></i> <span><b>EXPORT DATA</b></span></a></li>
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'data_asesi') {
												echo 'active';
											} ?>"><a href="panel_admin/data_asesi"><i class="fas fa-users"></i><span><b>DATA ASESI</b></span></a></li>
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'kirim_pesan') {
												echo 'active';
											} ?>"><a href="panel_admin/kirim_pesan"><i class="fas fa-envelope"></i> <span><b>KIRIM PESAN</b></span></a></li>
