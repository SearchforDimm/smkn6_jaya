                    ...
                    ?>
                        <tr>
                            ...
                            <td class="td-flex-col">
                                <a href="panel_admin/verifikasi_cetak/<?php echo $baris->no_pendaftaran; ?>" class="tombol-aksi tombol-print" title="Cetak Verifikasi" target="_blank"><i class='bx bx-printer'></i></a>
                                <?php if ($baris->status_verifikasi == 0) { ?>
                                    <a href="panel_admin/verifikasi/cek/<?php echo $baris->no_pendaftaran; ?>" class="tombol-verifikasi tombol-verif-admin-green" title="Verifikasi">
                                        <i class='bx bx-check'></i></a>
                                <?php } else { ?>
                                    <a href="panel_admin/verifikasi/cek/<?php echo $baris->no_pendaftaran; ?>" class="tombol-verifikasi tombol-unverif-admin-red" title="Batal Verifikasi">
